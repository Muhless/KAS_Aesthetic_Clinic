...
<div class="p-6 space-y-6">
    ...
    <div class="flex items-center justify-between">
        ...
        <div class="flex items-center gap-3">
            ...
            <div class="w-9 h-9 bg-sky-100 rounded-xl flex items-center justify-center text-sky-600 font-semibold text-sm">
    ...
    <div class="grid grid-cols-1 lg:grid-cols-3 gap-6">
        ...
        <div class="lg:col-span-2 space-y-5">
            ...
            <div class="bg-white rounded-2xl border border-slate-100 overflow-hidden">
                <div class="flex items-center justify-between px-5 py-4 border-b border-slate-50">
                    ...
                    <button class="text-xs bg-sky-500 hover:bg-sky-600 text-white px-3 py-1.5 rounded-lg transition cursor-pointer">
                        + Tambah Antrian
                    </button>
                </div>
                    ...
                    <table class="w-full text-sm">
                        ...
                        <tbody class="divide-y divide-slate-50">
                            ...
                            <tr class="hover:bg-slate-50 transition">
                                ...
                                <td class="px-5 py-3.5">
                                    <span class="text-xs px-2.5 py-1 rounded-full bg-amber-50 text-amber-600 font-medium">Menunggu</span>
                                </td>
                            </tr>
                            <tr class="hover:bg-slate-50 transition">
                                ...
                                <td class="px-5 py-3.5">
                                    <span class="text-xs px-2.5 py-1 rounded-full bg-sky-50 text-sky-600 font-medium">Proses</span>
                                </td>
                            </tr>
                            <tr class="hover:bg-slate-50 transition">
                                ...
                                <td class="px-5 py-3.5 text-slate-500">15:00</td>
                                <td class="px-5 py-3.5">
                                    <span class="text-xs px-2.5 py-1 rounded-full bg-rose-50 text-rose-500 font-medium">Antrian</span>
                                </td>
                            </tr>
                        </tbody>
                    </table>
        ...
        <div class="space-y-5">
            ...
            <div class="bg-white rounded-2xl border border-slate-100 overflow-hidden">
                ...
                <div class="divide-y divide-slate-50">
                    <div class="flex items-center gap-3 px-5 py-3.5">
                        <div class="w-9 h-9 bg-sky-100 rounded-xl flex items-center justify-center text-sky-600 font-semibold text-xs shrink-0">MN</div>
                        <div class="flex-1 min-w-0">
                    ...
                    <div class="flex items-center gap-3 px-5 py-3.5">
                        <div class="w-9 h-9 bg-violet-100 rounded-xl flex items-center justify-center text-violet-600 font-semibold text-xs shrink-0">NP</div>
                        <div class="flex-1 min-w-0">
            ...
            {{-- Akses Cepat --}}
            <div class="bg-white rounded-2xl border border-slate-100 p-5">
                <h3 class="font-semibold text-slate-800 text-sm mb-3">Akses Cepat</h3>
                <div class="grid grid-cols-2 gap-2">
                    <a href="/reservasi/create" class="flex flex-col items-center gap-1.5 p-3 rounded-xl bg-slate-50 hover:bg-sky-50 hover:text-sky-600 transition text-slate-500 text-center">
                        <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 4v16m8-8H4"/>
                        </svg>
                        <span class="text-xs font-medium">Reservasi</span>
                    </a>
                    <a href="/pasien/create" class="flex flex-col items-center gap-1.5 p-3 rounded-xl bg-slate-50 hover:bg-sky-50 hover:text-sky-600 transition text-slate-500 text-center">
                        <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M18 9v3m0 0v3m0-3h3m-3 0h-3m-2-5a4 4 0 11-8 0 4 4 0 018 0zM3 20a6 6 0 0112 0v1H3v-1z"/>
                        </svg>
                        <span class="text-xs font-medium">Pasien Baru</span>
                    </a>
                    <a href="/antrian" class="flex flex-col items-center gap-1.5 p-3 rounded-xl bg-slate-50 hover:bg-sky-50 hover:text-sky-600 transition text-slate-500 text-center">
                        <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M4 6h16M4 10h16M4 14h16M4 18h16"/>
                        </svg>
                        <span class="text-xs font-medium">Antrian</span>
                    </a>
                    <a href="/keuangan" class="flex flex-col items-center gap-1.5 p-3 rounded-xl bg-slate-50 hover:bg-sky-50 hover:text-sky-600 transition text-slate-500 text-center">
                        <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
