...
<head>
    ...
    <title>Register Dokter - KAS Aesthetic Clinic</title>
...
<body class="bg-gray-100 h-screen flex items-center justify-center">
    ...
    <div class="w-full max-w-sm bg-white p-6 rounded-xl shadow-lg">
        ...
        <form action="/register/dokter" method="POST">
            @csrf

            <!-- NAMA -->
            <div class="mb-4">
                <label class="block text-gray-600 mb-1 font-medium">Nama Dokter</label>
            ...
            <!-- NO TELEPON -->
            <div class="mb-4">
                <label class="block text-gray-600 mb-1 font-medium">Nomor HP (opsional)</label>
