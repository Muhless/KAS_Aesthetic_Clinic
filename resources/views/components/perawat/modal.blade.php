{{-- resources/views/components/perawat/modal.blade.php --}}
        ...
        <form action="{{ route('perawat.store') }}" method="POST" enctype="multipart/form-data">
            ...
            <div class="px-6 py-5 space-y-5 max-h-[70vh] overflow-y-auto">
                ...
                <div x-data="{ preview: null, fotoError: '{{ $errors->first('foto') }}' }" class="flex flex-col items-center gap-3">
                    ...
                    <input id="foto_perawat" name="foto" type="file"
                ...
                <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
                    ...
                    {{-- Tanggal Lahir --}}
                    <div x-data x-init="flatpickr($refs.tanggalLahirPerawat, {
                        dateFormat: 'Y-m-d',
                        altInput: true,
                        altFormat: 'd F Y',
                        locale: 'id',
                        ...
                        <label for="tanggal_lahir_perawat" class="block text-sm font-medium text-gray-700 mb-1.5">
                        ...
                        <div class="relative">
                            ...
                            <input x-ref="tanggalLahirPerawat" type="text" id="tanggal_lahir_perawat"
                                name="tanggal_lahir" placeholder="Pilih tanggal lahir" readonly
                    ...
                    {{-- Email --}}
                    <div class="">
                        <label for="email_perawat" class="block text-sm font-medium text-gray-700 mb-1.5">
                            Email
                        </label>
                        <div class="relative">
                            <span class="absolute left-3 top-1/2 -translate-y-1/2 text-gray-400 pointer-events-none">
                    ...
                    <div class="sm:col-span-2">
                        ...
                        <div class="relative">
                            ...
                            <input type="text" id="username_perawat" name="username"
                                value="{{ old('username') }}" placeholder="Contoh: perawat.sari"
                    ...
                    <div x-data="{ showPass: false }" class="sm:col-span-2">
                        ...
                        <div class="relative">
                            ...
                            <input :type="showPass ? 'text' : 'password'" id="password_perawat" name="password"
