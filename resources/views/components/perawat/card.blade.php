...
<div
    ...
    <!-- Foto Perawat -->
    <div class="relative aspect-[3/4] bg-gradient-to-br from-primary-50 to-purple-50 overflow-hidden">
        ...
        <div
            class="absolute top-3 right-3 flex gap-2 opacity-0 group-hover:opacity-100 transition-all duration-300 transform translate-y-[-10px] group-hover:translate-y-0">
    ...
    <div class="p-5 cursor-pointer hover:bg-gray-50 transition-colors">
        ...
        <div class="space-y-2.5">
            ...
            <div class="flex items-center gap-3 group/item">
                <div
                    class="flex-shrink-0 w-9 h-9 bg-primary-50 rounded-lg flex items-center justify-center group-hover/item:bg-primary-100 transition-colors">
            ...
            <div class="flex items-center gap-3 group/item">
                <div
                    class="flex-shrink-0 w-9 h-9 bg-purple-50 rounded-lg flex items-center justify-center group-hover/item:bg-purple-100 transition-colors">
