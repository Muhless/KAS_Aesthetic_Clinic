        ...
        <form action="{{ route('pasien.store') }}" method="POST" class="space-y-4">
            ...
            <div>
                ...
                <input type="text" name="nama" value="{{ old('nama') }}" required
                    class="w-full mt-1 px-3 py-2 border rounded-lg focus:ring-primary-500 focus:border-primary-500">
                @error('nama')
            ...
            <div class="flex justify-end gap-2 pt-2">
                <button @click="open = false" type="button" class="px-4 py-2 bg-gray-200 rounded-lg hover:bg-gray-300">
                    Batal
                </button>
