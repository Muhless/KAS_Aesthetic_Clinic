<div x-show="open" x-cloak class="fixed inset-0 z-50 flex items-center justify-center"
    ...
    <div class="relative z-10 w-full max-w-lg mx-4 bg-white rounded-2xl shadow-2xl overflow-hidden"
        ...
        <div class="flex items-center justify-between px-6 py-5 bg-gradient-to-r from-primary-600 to-primary-500">
            <div class="flex items-center gap-3">
                ...
                <h2 class="text-lg font-semibold text-white tracking-wide"
                    x-text="pasien.id ? 'Edit Pasien' : 'Tambah Pasien'"></h2>
            </div>
        ...
        {{-- Form --}}
        <form method="POST" :action="pasien.id ? `/pasien/${pasien.id}` : '{{ route('pasien.store') }}'">
            @csrf
            <input type="hidden" name="_method" :value="pasien.id ? 'PATCH' : 'POST'">
            ...
            <div class="px-6 py-5 space-y-4 max-h-[70vh] overflow-y-auto">
                ...
                <div>
                    ...
                    <input type="text" name="nama" :value="pasien.nama" placeholder="Masukkan nama lengkap"
                    ...
                    <div class="flex gap-3">
                        <label
                            ...
                            <input type="radio" name="jenis_kelamin" value="L"
                                :checked="pasien.jenis_kelamin === 'L'"
                        ...
                        <label
                            ...
                            <input type="radio" name="jenis_kelamin" value="P"
                                :checked="pasien.jenis_kelamin === 'P'"
                ...
                <div>
                    ...
                    <div class="relative">
                        ...
                        <input type="text" name="nomor_telepon" :value="pasien.nomor_telepon"
            ...
            <div class="flex items-center justify-end gap-3 px-6 py-4 border-t border-gray-100 bg-gray-50">
                ...
                <button type="submit"
                    ...
                    <span x-text="pasien.id ? 'Simpan Perubahan' : 'Simpan Pasien'"></span>
                </button>
            </div>
        </form>
    </div>
