<div x-show="open" x-cloak class="fixed inset-0 z-50 flex items-center justify-center"
    ...
    <div class="relative z-10 w-full max-w-lg mx-4 bg-white rounded-2xl shadow-2xl overflow-hidden"
        ...
        <div class="flex items-center justify-between px-6 py-5 bg-gradient-to-r from-primary-600 to-primary-500">
            <div class="flex items-center gap-3">
                ...
                <h2 class="text-lg font-semibold text-white tracking-wide"
                    x-text="produk.id ? 'Edit Produk' : 'Tambah Produk'"></h2>
            </div>
        ...
        {{-- Form --}}
        <form method="POST" :action="produk.id ? `/produk/${produk.id}` : '{{ route('produk.store') }}'"
            enctype="multipart/form-data">
            @csrf
            <input type="hidden" name="_method" :value="produk.id ? 'PATCH' : 'POST'">
            ...
            <div class="px-6 py-5 space-y-4 max-h-[70vh] overflow-y-auto">
                ...
                <div x-data="{ preview: null }" class="flex flex-col items-center gap-3">
                    ...
                    <input id="foto_produk" name="foto" type="file"
                ...
                <div>
                    ...
                    <input type="text" name="nama" :value="produk.nama" placeholder="Masukkan nama produk"
                ...
                <div>
                    ...
                    <textarea name="deskripsi" rows="2" x-model="produk.deskripsi" placeholder="Deskripsi singkat produk..."
                ...
                <div class="grid grid-cols-2 gap-4">
                    ...
                    <div>
                        ...
                        <div class="relative">
                            ...
                            <input type="number" name="harga" :value="produk.harga" min="0"
                    ...
                    <div class="flex gap-3">
                        <label
                            ...
                            <input type="radio" name="status" value="tersedia"
                                :checked="produk.status === 'tersedia'" class="accent-green-500">
                        ...
                        <label
                            ...
                            <input type="radio" name="status" value="tidak_tersedia"
                                :checked="produk.status === 'tidak_tersedia'" class="accent-red-500">
            ...
            <div class="flex items-center justify-end gap-3 px-6 py-4 border-t border-gray-100 bg-gray-50">
                ...
                <button type="submit"
                    ...
                    <span x-text="produk.id ? 'Simpan Perubahan' : 'Simpan Produk'"></span>
