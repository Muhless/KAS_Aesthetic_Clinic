...
<div class="bg-white rounded-2xl border border-gray-100 overflow-hidden flex flex-col group hover:border-gray-200 transition-all duration-200">
    ...
    <div class="relative h-44 bg-gray-50 overflow-hidden shrink-0">
        ...
        @if ($treatment->durasi)
            <div class="absolute top-2.5 left-2.5">
                <span class="inline-flex items-center gap-1 text-xs font-medium px-2 py-1 rounded-full bg-teal-50 text-teal-700 shadow-sm">
