<div class="bg-white rounded-2xl border border-slate-100 overflow-hidden">
    <div class="flex items-center justify-between px-5 py-4 border-b border-slate-50">
        <div>
            <h2 class="font-semibold text-slate-800 text-sm">Antrian Hari Ini</h2>
                    ...
                    <tr class="hover:bg-slate-50 transition">
                        ...
                        <td class="px-5 py-3.5">
                            <div class="flex items-center gap-2.5">
                                <div class="w-7 h-7 rounded-full bg-gray-100 text-gray-600 flex items-center justify-center font-semibold text-xs shrink-0">
                        ...
                        <td class="px-5 py-3.5">
                            ...
                            @elseif ($antrian->status == 'dipanggil')
                                <span class="text-xs px-2.5 py-1 rounded-full bg-blue-50 text-blue-600 font-medium">Dipanggil</span>
                            @else
